...
class QueryStringArrayExpansionTestCase(unittest.TestCase):
    ...
    def test_query_string_parser_expands_uri_array(self):
        ...
        self.assertEqual(parser, {'field[spam]': 'foo', 'field[eggs][42]': 'bar', 'field[ham][spam][eggs]': 'baz'})
        
        parser.expand_array()
        self.assertEqual(parser, {'field': {'spam': 'foo', 'eggs': {'42': 'bar'}, 'ham': {'spam': {'eggs': 'baz'}}}})
    ...
    def test_expand_array_returns_the_parser_instance(self):
        ...
        self.assertIs(parser, parsed)
        self.assertEqual(parsed, {'field': {'spam': 'foo', 'eggs': {'42': 'bar'}, 'ham': {'spam': {'eggs': 'baz'}}}})
